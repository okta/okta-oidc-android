...
public class SampleActivity extends AppCompatActivity implements SignInDialog.SignInDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignInDeviceSecret.setOnClickListener(v -> {
            ...
            mAuthClient.signIn(tokens.secret, tokens.subject,
                ...
                new ResultCallback<AuthorizationStatus, AuthorizationException>() {
                    ...
                    public void onSuccess(@NonNull AuthorizationStatus status) {
                        if (status == AuthorizationStatus.AUTHORIZED) {
                            ...
                            try {
                                String secret = client.getTokens().getDeviceSecret();
    ...
    private void saveNativeSSOTokens(@NotNull NativeSSOTokens tokens) {
        ...
        getSharedPreferences(SampleActivity.class.getName(), MODE_PRIVATE)
                .edit().putString(PREF_DEV_SECRET_SUBJECT, tokens.subject).apply();
    }

...
public class DelimitedVersionTest {
    ...
    public void testCompare_withSelf() {
        ...
        Assertions.assertThat(version).isEqualTo(version);
    ...
    public void testCompare_withEquivalent() {
        ...
        Assertions.assertThat(version).isEqualTo(equivalent);
    ...
    public void testCompare() {
        ...
        Assertions.assertThat(version).isNotEqualTo(other);
    }

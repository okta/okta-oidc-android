...
class AsyncWebAuthClient implements AsyncWebAuth {
    ...
    AsyncWebAuthClient(Executor executor, OIDCAccount oidcAccount, OktaState oktaState, HttpConnectionFactory httpConnectionFactory, String[] supportedBrowsers, int customTabColor) {
        mSyncAuthClient = new SyncWebAuthClient(oidcAccount, oktaState, httpConnectionFactory, supportedBrowsers, customTabColor);
